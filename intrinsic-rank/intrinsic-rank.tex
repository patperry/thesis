...
The scree plot is popular device for choosing the truncation rank in Principal Components Analysis.  

rule-of-thumb for choosing the truncation rank for Principal Components Analysis is to take the ``elbow'' of the scree plot.  
...
\begin{figure}[th]
    \begin{center}
        ...
        \caption{
            ...
            We generate a matrix as $\mX = \sqrt{n} \mU \mD \mV^\trans + \mE$ 
            ...
            $\sum_{k} \had d_k^2 = 1$.  The next two rows show
