	...
	K
		&=
			\frac{3}{3
					 ...
					 \right)}.
\end{align*}
For very large or very small aspect ratios ($\gamma \to 0$ or $\gamma \to \infty$), and $K \to 1$.  In these situations one should leave out almost all of the matrix when performing
bi-cross-validation.
