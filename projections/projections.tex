...
\begin{lemma}
    If $\vx, \vy \in \reals^p$ and 
    \(
        \mP \sim \Unif\big( \grassmann_k (\reals^p) \big),
    \)
    then
    \[
...
\begin{proof}
    ...
    \begin{align*}
        \E \left[ \vx^\trans \mP \vy \right]
            &= \sum_{i,j} \frac{k}{p} \, x_i \, y_j \, \delta_{ij} \\
            &= \frac{k}{p} \, \vx^\trans \vy
    \end{align*}
    and
    \begin{align*}
        ...
        \begin{split}
            ...
            &\qquad\qquad\qquad\qquad\quad+
                \frac{p-2}{ (p-1) (p+2) } ( \vx^\trans \vy )^2 \bigg\}
        \end{split}
    \end{align*}
\end{proof}