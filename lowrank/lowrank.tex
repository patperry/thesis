...
of \iid random variables.  First, we give a weak law of large numbers:
...
\begin{lemma}[McLeish]\label{L:mcleigh}
    ...
    $\sum_{i=1}^N X^N_i \tod \Normal (0, \, \sigma^2)$.
\end{lemma}
...
\begin{lemma}\label{L:clt-weighted}
    ...
    \[
        ...
        \right]
        \tod
        \Normal( 0, \, \Sigma^X \bullet \Sigma^W),
    \]
