...
is a slight abuse of terminology.  A more standard use of the term ``secular equation'' would be analogous to a characteristic equation and involve a determinant, i.e. $\det \mT_n(z) = 0$.  However, for our purposes it will be more convenient to work with $f_n$.
