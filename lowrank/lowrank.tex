...
\begin{lemma}
    ...
    $(\tmu_i, \ve_i)$, such that $f_n(z_n, \vx_n) = 0$ and $\mu_i \neq \mu_j$
    for $i \neq j$, then:
    \begin{enumerate}[(i)]
        \item \[
                  \sqrt{n} ( z_n - \tmu_i) 
                  = 
                  -
                  \frac{\left(\mT_{n,1}(\tmu_i) \right)_{ii}}
                       {\left(\mT_0'(\tmu_i) \right)_{ii}}
                  +
                  \ohP(1).
              \]
        \item \[
        ...
        \item \[
                  ...
                  = 
                  -
                  \frac{\left(\mT_{n,1}(\tmu_i) \right)_{ji}}
                       {\left(\mT_0(\tmu_i) \right)_{jj}}
                  +
                  \ohP(1)
                  \quad
                  \text{for $i \neq j$.}
    ...
    \begin{proof}
        ...
        \begin{align*}
            0
                &=
                \frac{1}{\sqrt{n}}
                \left(\mT_{n,1}(\tmu_i) \right)_{ii}
                +
                \left(\mT_0'(\tmu_i) \right)_{ii} ( z_n - \tmu_i )
                +
                \ohP\left( \frac{1}{\sqrt{n}} \right), \\
            0
                &=
                \frac{1}{\sqrt{n}}            
                \left(\mT_{n,1}(\tmu_i) \right)_{ji}
                +
                \left(\mT_0(\tmu_i) \right)_{jj}
                x_{n,j} 
                +
